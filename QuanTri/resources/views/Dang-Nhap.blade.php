                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Nhập tên đăng nhập và mật khẩu để vào trang admin</p>
                                </div>
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="ten_dang_nhap" required="" placeholder="Nhập tên đăng nhập">
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="matkhau">Mật khẩu</label>
                                        <input class="form-control" type="password" required="" name="mat_khau" placeholder="Nhập mật khẩu">
                                    </div>
