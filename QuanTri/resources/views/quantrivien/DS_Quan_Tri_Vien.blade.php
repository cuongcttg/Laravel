...
<div class="row">
	<div class="col-12">
	    <div class="card">
	        <div class="card-body">
	            <h4 class="header-title">Danh sách các quản trị viên</h4>
	            <a href="{{	route('quan-tri-vien.them-moi-qtv') }}" style="margin-bottom: 10px;" type="button" class="btn btn-primary waves-effect waves-light">Thêm mới quản trị viên</a>
